...
export { 
    RAID_MANAGEMENT_ROLES, SIGN_TO_RAID_ROLES, RAIDS_PRIORITY_ROLES, DISMISSED_RAIDS_PRIORITY_ROLES,
...
const SIGN_TO_RAID_ROLES = [ "maratończyk", "MaratończykPlus", "Famowicz" ];
